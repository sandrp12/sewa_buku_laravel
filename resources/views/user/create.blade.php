            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}"> @csrf
                        <div>
                            <label for="name" class="col-md-4 col-from-label text-md-right">{{ __('Nama') }}</label>
                            <div class="col-md-6">
                        ...
                        <div>
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('email') }}" requered autocomplete="email">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div>
                            <label for="confim-password" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
                            <div class="col-md-6">
